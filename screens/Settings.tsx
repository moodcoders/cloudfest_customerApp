...
const Settings = ({ navigation }: any) => {
  return (
    <SafeAreaView>
      ...
      <View
        style={{ backgroundColor: '#EDF1FB', height: '100%', borderRadius: 20 }}
      >
        ...
        <View style={styles.card}>
          ...
          <View>
            <Text style={{ color: '#ADADAD', fontSize: 20, padding: 10 }}>
              Account Settings
            </Text>
          </View>
          ...
          <View style={styles.setting}>
            ...
            <TouchableOpacity>
              <Icon name='chevron-right' color='#333' style={styles.backIcon} />
            </TouchableOpacity>
          </View>
          <View style={styles.setting}>
