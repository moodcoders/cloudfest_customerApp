...
const PayPage = ({setStripeTab, setBookingDone }: any) => {
    ...
    return (
        ...
        <View style={styles.payContainer}>
            <PayCard icon='cc-mastercard' name='Credit Card' color='#FF5E02' setStripeTab={setStripeTab} n='1'/>
            <PayCard icon='google' name='Google Pay' color='#4285F4' />
            <PayCard icon='inr' name='UPI' color='#599BD8' />
            <PayCard icon='money' name='Cash' color='#65CF53' setBookingDone={setBookingDone} n='4'/>
